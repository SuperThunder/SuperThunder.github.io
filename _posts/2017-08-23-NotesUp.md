...
The script handles _most_ dependencies and installation. However, it is not very error tolerant so you need to watch for errors. I had to install *libgtkspell3-3-dev*.
...
### (Fixing your system after adding all those PPAs)[https://askubuntu.com/a/722582]
